...
Get the best parameter set by using the data consistency measure.
...
from .our_score_base import determine_dqr, get_cells, is_clean, make_abstraction

DETECTOR = "our_score_full"
